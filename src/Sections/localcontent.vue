    ...
    >
      ...
      <div class="">
        <div>
          ...
          >
          <input
            class="focus:shadow-outline mt-2 w-full rounded-lg bg-gray-300 p-3 text-gray-900 focus:outline-none"
            type="text"
            placeholder=""
          />
        </div>
        <div class="mt-8">
          <span class="text-sm font-bold uppercase text-gray-600">Email</span>
          <input
            class="focus:shadow-outline mt-2 w-full rounded-lg bg-gray-300 p-3 text-gray-900 focus:outline-none"
            type="text"
          />
        ...
        <div class="mt-8">
          <span class="text-sm font-bold uppercase text-gray-600">Message</span>
          <textarea
            class="focus:shadow-outline mt-2 h-32 w-full rounded-lg bg-gray-300 p-3 text-gray-900 focus:outline-none"
          ></textarea>
        </div>
        <div class="mt-8">
          <button
            class="focus:shadow-outline w-full rounded-lg bg-orange-500 p-3 text-sm font-bold uppercase tracking-wide text-gray-100 focus:outline-none"
          >
            Send Message
          </button>
        </div>
